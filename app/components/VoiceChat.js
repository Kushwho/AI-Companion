      ...
      <div className={`sakhi-voice-box${connected ? ' active' : ''}`} id="sakhiVoiceBox">
        <div className="sakhi-voice-mascot-container">
          ...
          <div className={`sakhi-voice-mascot${mascotExpr ? ` expr-${mascotExpr}` : ''}`} id="sakhiMascot">
            <Image src="/sakhi-mascot.png" alt="Playla mascot listening during a voice conversation, animated with a gentle pulse to indicate the AI companion is actively engaged" width={150} height={150} priority fetchPriority="high" />
          </div>
        </div>
